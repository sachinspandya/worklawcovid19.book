...
Most full-time workers receive a few weeks of paid time off per year, including paid sick days. However, lower-paid workers are less likely to receive paid sick leave than higher paid workers and fewer than half of part-time workers received paid sick days at all (Figure 1). Paid leave to take care of a family member who is seriously ill is relatively unusual across all wage levels [@BLS2019, tbl. 31].


```{r leave_avg_wage, echo = FALSE, message = FALSE, warning = FALSE, fig.cap=""}
...
pl_plot <- ggplot(data = d2, aes(fill=quartile, y=pct, x=type)) + 
            ...
            ylab("Percent") +
            ylim(0, 100) +
            labs(title = "Access to Paid Leave, by Average Worker Wage",
