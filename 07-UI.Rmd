...
dotplot <- ggplot(d2, aes(x = amount, y = reorder(state, amount))) + geom_line(aes(group = state)) +
  ...
  labs(
      #title = "Min/Max State UI Weekly Benefits by State, January 2020",
